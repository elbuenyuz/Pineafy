...
class friendHorosocopeCollectionView: UIView, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    ...
    let categoriesArray = [
        ...
        HorosocopeModel(sign: "PISCES", date: "10/04/2018", likes: 5, horoscope: "horoscope information",image:#imageLiteral(resourceName: " Cancer")),
        HorosocopeModel(sign: "LIBRA", date: "10/04/2018", likes: 5, horoscope: "horoscope information",image:#imageLiteral(resourceName: " Aries")),
        HorosocopeModel(sign: "SCORPIO", date: "10/04/2018", likes: 5, horoscope: "horoscope information",image:#imageLiteral(resourceName: " Scorpio")),
        HorosocopeModel(sign: "PISCES", date: "10/04/2018", likes: 5, horoscope: "horoscope information",image:#imageLiteral(resourceName: " Taurus")),
        HorosocopeModel(sign: "LIBRA", date: "10/04/2018", likes: 5, horoscope: "horoscope information",image:#imageLiteral(resourceName: " Capricorn")),
        HorosocopeModel(sign: "AQUARIUS", date: "10/04/2018", likes: 5, horoscope: "horoscope information",image:#imageLiteral(resourceName: " Sagittarius"))
